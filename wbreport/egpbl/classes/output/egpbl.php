...
namespace wbreport_egpbl\output;
...
use renderable;
use templatable;
use wbreport_egpbl\local\table\egpbl_table;
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class egpbl implements renderable, templatable, wbreport_interface {
    ...
    public function __construct() {
        ...
        // Merge params.
        $params = array_merge($inparams1, $inpblsparams);
